...
expName = 'NameGenerationTask'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='/Users/mettapham/Downloads/HOMES_NameGeneration/NameGenerationTask_lastrun.py',
...
text = visual.TextStim(win=win, name='text',
    text='Welcome to the Name Generation Task',
    font='Open Sans',
...
text_2 = visual.TextStim(win=win, name='text_2',
    text='In this task, you will be given objects to look at and type in what you think the object might be called.\n\nPress SPACEBAR to begin',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
textbox_resp = visual.TextBox2(
     win, text=None, font='Open Sans',
     pos=(0, -.2),     letterHeight=0.05,
     size=(.6, .15), borderWidth=4.0,
...
text_3 = visual.TextStim(win=win, name='text_3',
    text='Thank you for participating in the Name Generation Task',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
...
trials = data.TrialHandler(nReps=1.0, method='random', 
    ...
    trialList=data.importConditions('landmark_stims_NameGen.xlsx'),
...
for thisTrial in trials:
    ...
    _key_resp_2_allKeys = []
    # keep track of which components have finished
    trialComponents = [imageA, imageB, imageC, textbox_resp, text_4, key_resp_2]
    ...
    while continueRoutine:
        ...
        # *textbox_resp* updates
        if textbox_resp.status == NOT_STARTED and tThisFlip >= 0.0-frameTolerance:
            # keep track of start time/frame for later
            textbox_resp.frameNStart = frameN  # exact frame index
            textbox_resp.tStart = t  # local t and not account for scr refresh
            textbox_resp.tStartRefresh = tThisFlipGlobal  # on global time
            win.timeOnFlip(textbox_resp, 'tStartRefresh')  # time at next scr refresh
            # add timestamp to datafile
            thisExp.timestampOnFlip(win, 'textbox_resp.started')
            textbox_resp.setAutoDraw(True)
    ...
    for thisComponent in trialComponents:
        if hasattr(thisComponent, "setAutoDraw"):
            thisComponent.setAutoDraw(False)
    trials.addData('textbox_resp.text',textbox_resp.text)
    # check responses
